<div class="dashboard-header fade-in">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
          ...
          <div class="search-container order-3 order-md-2 flex-grow-1" style="max-width: 480px;">
            <div class="position-relative">
              <i class="fas fa-search search-icon"></i>
              <input class="form-control search-input ps-5" type="text" placeholder="Rechercher produits, ventes, clients...">
              <span class="position-absolute end-0 top-50 translate-middle-y me-2 d-none d-md-inline text-muted small">Ctrl /</span>
            </div>
          </div>
